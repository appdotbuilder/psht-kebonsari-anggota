...
export default function MemberEdit({ member }: Props) {
    ...
    const { data, setData, processing, errors } = useForm({
        ...
        tahun_pengesahan_tingkat_1: member.tahun_pengesahan_tingkat_1?.toString() || '',
        tahun_pengesahan_tingkat_2: member.tahun_pengesahan_tingkat_2?.toString() || '',
        rayon_sub_rayon: member.rayon_sub_rayon || '',
    });
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Edit ${member.nama_lengkap} - PSHT Ranting Kebonsari`} />
                ...
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400">
                            Perbarui data anggota {member.nama_lengkap}
                        </p>
                    </div>
                ...
                <div className="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <form onSubmit={submit} className="p-6">
                        <div className="grid gap-6 md:grid-cols-2">
                            ...
                            {/* Foto */}
                            <div className="md:col-span-2">
                                <Label htmlFor="foto">Foto Baru (Opsional)</Label>
                                <Input
                                    id="foto"
                                    type="file"
                                ...
                                <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                    Format: JPEG, PNG, JPG. Maksimal 2MB. Kosongkan jika tidak ingin mengganti foto.
                                </p>
                                {errors.foto && (
